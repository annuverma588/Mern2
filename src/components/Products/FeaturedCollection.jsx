      ...
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl overflow-hidden">
        ...
        <div className="lg:w-1/2 p-8 text-center lg:text-left">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Discover high-quality, stylish apparel designed for everyday wear.
            Our collection combines comfort and fashion, ensuring you look
            and feel your best no matter the occasion.
          </p>
